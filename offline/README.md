...
channel| String | 渠道类型 | 根据不同场景选择不同的支付方式 | WX\_NATIVE、WX_SCAN、ALI\_OFFLINE\_QRCODE、ALI\_SCAN、BC\_ALI\_SCAN,BC\_WX\_SCAN,BC\_ALI\_QRCODE,BC\_SCAN(详见附注）| 是
...
seller_id | String | 商家id | 商家id | 商家id | 选填
buyer_id | String | 购买者id | 购买者id | 购买者id | 选填
...
WX\_SCAN: 微信条形码支付  
ALI\_SCAN: 支付宝条形码支付  
BC\_ALI\_QRCODE: BC版支付宝二维码支付  
BC\_ALI\_SCAN: BC版支付宝条形码支付  
BC\_WX\_SCAN: BC版微信条形码支付  
BC\_SCAN: BC版支付宝、微信扫码支付
...
channel| String | 渠道类型 | 根据不同场景选择不同的支付方式 | WX\_NATIVE、WX\_SCAN、ALI\_OFFLINE\_QRCODE、ALI_SCAN、BC\_ALI\_SCAN,BC\_WX\_SCAN,BC\_ALI\_QRCODE,BC\_SCAN(详见支付附注） | 否
